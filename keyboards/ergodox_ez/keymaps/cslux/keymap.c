...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [AUX] = LAYOUT_ergodox_pretty(
         KC_TRNS, KC_MPRV, KC_VOLD, KC_MPLY, KC_VOLU, KC_MNXT, KC_TRNS, KC_SLEP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSLS, QK_BOOT, KC_TRNS, KC_F12, KC_F11, KC_F10, KC_F9, KC_MUTE, KC_TRNS, KC_TRNS, KC_CIRC, KC_P7, KC_P8, KC_P9, KC_PAST, KC_PERC, KC_TRNS, KC_F8, KC_F7, KC_F6, KC_F5, KC_MSTP, KC_LPRN, KC_P4, KC_P5, KC_P6, KC_PMNS, KC_RPRN, KC_TRNS, KC_F4, KC_F3, KC_F2, KC_F1, KC_TRNS, KC_TRNS, KC_TRNS, KC_QUES, KC_P1, KC_P2, KC_P3, KC_PPLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0, KC_PDOT, KC_PCMM, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
        ),
